  ...
  return {
    ...
    link: function(scope, element, attributes) {
      ...
      init = function() {
        ...
        plotArea.find('.legend table').css('width', 'auto')
      ...
      // nk
      // reinit after window resize
      $(window).on('resize.conApp', onOptionsChanged);

      // nk
      // show tooltips
      if(scope.options.conTooltip) {
        scope.options.conTooltip(plotArea);
      }
