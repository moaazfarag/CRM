...
class BaseController extends Controller {
   ...
   public static function isBelongToCompany($table,$col,$id){
    ...
    public static  $messages = array(
        ...
        'loan_val.regex'      =>  'يمكنك فقط ادخال ارقام صحيحه او ارقام عشرية بحد اقصى رقمين عشريين  ',
        'loan_currBal.regex'  =>  'يمكنك فقط ادخال ارقام صحيحه او ارقام عشرية بحد اقصى رقمين عشريين ',
        'date'                =>  ' يرجى ادخال التاريخ بشكل صحيح ',
        'min'                 =>  'لا بد أن يحتوى هذا الحقل على ثلاثة أحرف على الأقل',
        'val.regex'           =>  'يمكنك فقط ادخال ارقام صحيحه او ارقام عشرية بحد اقصى رقمين عشريين ',
        );
}
