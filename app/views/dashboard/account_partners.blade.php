      ...
      <div id="account_partners" class="col s12">



        <div class="card minimized">
          <div class="title">
            <h5><i class="mdi mdi-notification-event-available"></i> اضف شريك جديد</h5>
                  ...
                  <div class="row">
                      <div class="col s12 l12">
                          <button class="waves-effect btn">اضف </button>
                                   ...
                                   <table id="table_partners" class="display table table-bordered table-striped table-hover">
