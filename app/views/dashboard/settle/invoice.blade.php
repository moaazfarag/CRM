...
@section('content')
  <!-- Main Content -->
  <section  ng-init='invoiceItems ={{ isset($newArray)?json_encode($newArray):'[]' }}' ng-app="itemApp"  ng-controller="mainController" class="content-wrap ecommerce-invoice">
            ...
            <table class="table table-responsive invoice-table">
              ...
              <tbody>
                ...
                <tr ng-repeat="invoiceItem  in invoiceItems">
                  ...
                  <td class="center-align">@{{ invoiceItem.quantity }}</td>
                  <td class="center-align">@{{ invoiceItem.serial }}</td>
                </tr>
                <tr>
