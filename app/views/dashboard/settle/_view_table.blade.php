  ...
  <tbody>
    <tr ng-repeat="invoiceItem in invoiceItems">
        ...
        <td>
            ...
            <input  class="input-without-border" name="name_@{{ invoiceItems.indexOf(invoiceItem) }}" ng-model="invoiceItem.name" type="text" />
        ...
        <td>
            <input   class="input-without-border"  name="serial_@{{ invoiceItems.indexOf(invoiceItem) }}"  ng-model="invoiceItem.serial" type="text" value="@{{ invoiceItem.quantity }}"/>
        </td>
    </tr>
  </tbody>
</table>
