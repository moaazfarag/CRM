@include('dashboard.account_nav')
      <div id="account_supplier" class="col s12">



        <div class="card minimized">
          <div class="title">
            <h5><i class="mdi mdi-notification-event-available"></i> اضف مورد جديد</h5>
...
ملاحظات
               ...
               <table id="table_supplier" class="display table table-bordered table-striped table-hover">
