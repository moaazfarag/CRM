...
<div class="wrap">
    <div class="logo">
        ...
        <hr/>
        <h4> <span class="title">
            عفواً لم يتم تفعيل الشركة بعد يرجى مراجعة بريدك الألكترونى والضغط على رابط التأكيد
            </span>
            <br/>
            <br/>
       <img src="{{ URL::asset('dashboard/img/mail3.jpg') }}" style="width:350px; height:150px;"/>
        </h4>
