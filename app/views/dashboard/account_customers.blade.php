      ...
      <div id="account_customers" class="col s12">
        ...
        <div class="card minimized">
          <div class="title">
            <h5><i class="mdi mdi-notification-event-available"></i> اضف عميل جديد</h5>
                  ...
                  <div class="row no-margin-top">
                    ...
                    <div class="col s12 l4">
                      <div class="input-field">
                        ...
                        <input name="account_name" id="branch-name" type="text" placeholder="  اسم العميل  ">
                      </div>
                    </div>
                     <div class="row no-margin-top">
                    <div class="col s12 l2">
...
عنوان العميل
                            ...
                            <div class="col s12 m6 l8">
                              <div class="input-field">
                                <i class="mdi mdi-social-person prefix"></i>
                                <input name="account-address" id="account-address" type="text" placeholder="عنوان  العميل">
                              </div>
                            </div>
