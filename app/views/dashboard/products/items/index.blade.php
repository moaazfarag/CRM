...
<section ng-app="itemApp" ng-controller="mainController" class="content-wrap ecommerce-dashboard">
    <div id="bank" class="col s12">
     @if(PerC::isShow('main_info','item','add','addItem')||PerC::isShow('main_info','item','edit','editItem'))
                    ...
                    @if($co_info->co_supplier_must)
                        ...
                        <div ng_show="account.type" class="col s2 l3">
                            <select name="account_id" ng-required='pay_type == "on_account"'
                                    ng-change='getAccountInfo()' ng-model="account.id" class='browser-default'>
                ...
                <div class="row no-margin-top">
                    <div class="col s12 l10">
                        <div class="input-field">
                            ...
                            <textarea name="notes" id="notes" class="materialize-textarea"
                                      length="120"> {{ @$item->notes }}</textarea>
