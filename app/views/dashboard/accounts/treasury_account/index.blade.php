...
<section ng-app="itemApp" ng-controller="mainController" class="content-wrap ecommerce-dashboard">
    @if(PerC::isShow('p_general_accounts','p_directMovement','edit','editDirectMovement') || PerC::isShow('p_general_accounts','p_directMovement','add','addDirectMovement'))
        <div class=" card">
            <div class="title">
                <h5>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col s12 l1">
                        ...
                        <input name="price_type" value="debit" {{ isset($debit) ?'checked':'' }} type="radio"
                               id="radios1-2"/>
        ...
        @endif
                <!-- /Store Settings -->
        @if(PerC::isShow('p_general_accounts','p_directMovement','show_add_edit'))
