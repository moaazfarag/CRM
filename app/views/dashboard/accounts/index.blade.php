...
<section class="content-wrap ecommerce-dashboard">
    ...
    <div id="account_bank" class="col s12">
        @if(PerC::isShow('main_info','add_account','add','addAccount')||PerC::isShow('main_info','add_account','edit','editAccount'))
            ...
            <div class="card">
                <div class="title">
                    <h5>
                        <i class="mdi mdi-notification-event-available"></i> @lang('main.addAccount') {{$arabicName}} @lang('main.new')
                    </h5>
                ...
                <div class="content">
                    ...
                    @if(PerC::isShow('main_info','add_account','show_add_edit'))
