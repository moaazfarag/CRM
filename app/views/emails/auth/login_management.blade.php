...
<section id="sign-in">
    ...
    <!-- Sign In Form -->
    {{ Form::open(array('route'=>'checkLoginManagement'))}}

    <div class="card-panel">

        <div class="card-panel blue lighten-4" style="color:#000; text-align:center; "><strong>تسجيل الدخول للوحة  تحكم الإدارة</strong></div>
