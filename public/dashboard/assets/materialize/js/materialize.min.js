...
jQuery.extend(jQuery.easing, {
    ...
    t.fn.scrollTo = function (e) {
        ...
        this.each(function () {
            ...
            function o() {
                ...
                var i = r.offset().left, o = 0, a = s.gutter;
                i + l.innerWidth() > t(window).width() && (o = r.innerWidth() - l.innerWidth(), a = -1 * a), l.css({
                    position: "absolute",
                    top: r.position().top + e,
                    left: r.position().left + o + a
            ...
            var r = t(this), s = t.extend({}, i, e), l = t("#" + r.attr("data-activates"));
            if (n(), r.after(l), s.hover) {
                var u = !1;
                r.unbind("click." + r.attr("id")), r.on("mouseenter", function () {
                    u === !1 && (o(), u = !0)
                }), r.on("mouseleave", function (e) {
                    t(e.toElement).closest(".dropdown-content").is(l) || (l.stop(!0, !0), a(), u = !1)
                }), l.on("mouseleave", function (e) {
                    t(e.toElement).closest(".dropdown-button").is(r) || (l.stop(!0, !0), a(), u = !1)
                })
            } else r.parent(".btn-group")[0] && (r = r.parent(".btn-group")), r.unbind("click." + r.attr("id")), r.bind("click." + r.attr("id"), function (e) {
                r[0] == e.currentTarget && 0 === t(e.target).closest(".dropdown-content").length ? (e.preventDefault(), o()) : r.hasClass("active") && (a(), t(document).unbind("click." + l.attr("id"))), l.hasClass("active") && t(document).bind("click." + l.attr("id"), function (e) {
                    !l.is(e.target) && !r.is(e.target) && !r.find(e.target).length > 0 && (a(), t(document).unbind("click." + l.attr("id")))
                })
            });
            r.on("open", o), r.on("close", a)
        })
    }, t(document).ready(function () {
    ...
    t(document).ready(function () {
        ...
        t(document).on("mousedown", s, function (e) {
            ...
            i.length <= 0 && (i = t('<span class="thumb"><span class="value"></span></span>'), t(this).append(i)), r = !0, t(this).addClass("active"), i.hasClass("active") || i.velocity({
                height: "30px",
                width: "30px",
                top: "-20px",
                marginLeft: "-15px"
            }, {duration: 300, easing: "easeOutExpo"});
            var n = e.pageX - t(this).offset().left, o = t(this).outerWidth();
            0 > n ? n = 0 : n > o && (n = o), i.addClass("active").css("left", n), i.find(".value").html(t(this).children("input[type=range]").val())
        ...
        t(this).each(function () {
            if ($select = t(this), !$select.hasClass("browser-default")) {
                ...
                var a = t('<ul id="select-options-' + n + '" class="dropdown-content select-dropdown"></ul>'), r = $select.children("option");
                if (void 0 !== $select.find("option:selected"))var s = $select.find("option:selected"); else var s = a.first();
                r.each(function () {
                ...
                $select.before(u), u.before(l), t("body").append(a), $select.is(":disabled") || u.dropdown({hover: !1}), $select.attr("tabindex") && t(u[0]).attr("tabindex", $select.attr("tabindex")), $select.addClass("initialized"), u.on("focus", function () {
                    t(this).trigger("open"), s = t(this).val(), selectedOption = a.find("li").filter(function () {
                    ...
                    return 9 == e.which ? void u.trigger("close") : 40 != e.which || a.is(":visible") ? void((13 != e.which || a.is(":visible")) && (e.preventDefault(), letter = String.fromCharCode(e.which).toLowerCase(), letter && (filterQuery.push(letter), string = filterQuery.join(""), newOption = a.find("li").filter(function () {
...
Vel = $ ? $.Velocity : Velocity, !function (t, e, i, n) {
    ...
    function x(t, e) {
        for (var i, o, a = e[0].toUpperCase() + e.slice(1), r = 0; r < le.length;) {
            if (i = le[r], o = i ? i + a : e, o in t)return o;
            r++
        }
        return n
    }
    ...
    function $(t) {
        ...
        return new (e = i ? i : ye ? z : me ? W : ge ? R : L)(t, T)
    }

    function T(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, a = e & Ce && 0 === n - o, r = e & (Te | Oe) && 0 === n - o;
        i.isFirst = !!a, i.isFinal = !!r, a && (t.session = {}), i.eventType = e, O(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
    }
    ...
    function O(t, e) {
        ...
        var a = i.firstInput, r = i.firstMultiple, s = r ? r.center : a.center, l = e.center = D(n);
        e.timeStamp = he(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = V(s, l), e.distance = q(s, l), P(i, e), e.offsetDirection = I(e.deltaX, e.deltaY), e.scale = r ? j(r.pointers, n) : 1, e.rotation = r ? _(r.pointers, n) : 0, A(i, e);
        var u = t.element;
    ...
    function P(t, e) {
        ...
        (e.eventType === Ce || a.eventType === Te) && (o = t.prevDelta = {
            x: a.deltaX || 0,
            y: a.deltaY || 0
    ...
    function A(t, e) {
        ...
        if (e.eventType != Oe && (l > Se || s.velocity === n)) {
            var u = s.deltaX - e.deltaX, c = s.deltaY - e.deltaY, d = M(l, u, c);
            o = d.x, a = d.y, i = pe(d.x) > pe(d.y) ? d.x : d.y, r = I(u, c), t.lastInterval = e
    ...
    function E(t) {
        ...
        return {timeStamp: he(), pointers: e, center: D(e), deltaX: t.deltaX, deltaY: t.deltaY}
    }
    ...
    function I(t, e) {
        return t === e ? Pe : pe(t) >= pe(e) ? t > 0 ? Ae : Ee : e > 0 ? De : Me
    }
    ...
    function _(t, e) {
        return V(e[1], e[0], je) - V(t[1], t[0], je)
    }

    function j(t, e) {
        return q(e[0], e[1], je) / q(t[0], t[1], je)
    }

    function L() {
        this.evEl = ze, this.evWin = Fe, this.allow = !0, this.pressed = !1, C.apply(this, arguments)
    }

    function z() {
        this.evEl = Ne, this.evWin = Re, C.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
    }

    function F() {
        this.evTarget = Ye, this.evWin = Xe, this.started = !1, C.apply(this, arguments)
    }

    function Q(t, e) {
        var i = b(t.touches), n = b(t.changedTouches);
        return e & (Te | Oe) && (i = w(i.concat(n), "identifier", !0)), [i, n]
    }
    ...
    function N(t, e) {
        ...
        if (a = i.filter(function (t) {
                return v(t.target, l)
            }), e === Ce)for (o = 0; o < a.length;)n[a[o].identifier] = !0, o++;
        for (o = 0; o < r.length;)n[r[o].identifier] && s.push(r[o]), e & (Te | Oe) && delete n[r[o].identifier], o++;
    ...
    function X(t) {
        this.id = k(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = p(this.options.enable, !0), this.state = oi, this.simultaneous = {}, this.requireFail = []
    }

    function B(t) {
        return t & ui ? "cancel" : t & si ? "end" : t & ri ? "move" : t & ai ? "start" : ""
    }

    function U(t) {
        return t == Me ? "down" : t == De ? "up" : t == Ae ? "left" : t == Ee ? "right" : ""
    }
    ...
    function oe(t, e) {
        return e = e || {}, e.recognizers = p(e.recognizers, oe.defaults.preset), new ae(t, e)
    }

    function ae(t, e) {
        e = e || {}, this.options = l(e, oe.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = $(this), this.touchAction = new H(this, this.options.touchAction), re(this, !0), r(e.recognizers, function (t) {
    ...
    var le = ["", "webkit", "moz", "MS", "ms", "o"], ue = e.createElement("div"), ce = "function", de = Math.round, pe = Math.abs, he = Date.now, fe = 1, ve = /mobile|tablet|ip(ad|hone|od)|android/i, ge = "ontouchstart"in t, ye = x(t, "PointerEvent") !== n, me = ge && ve.test(navigator.userAgent), be = "touch", we = "pen", xe = "mouse", ke = "kinect", Se = 25, Ce = 1, $e = 2, Te = 4, Oe = 8, Pe = 1, Ae = 2, Ee = 4, De = 8, Me = 16, Ie = Ae | Ee, qe = De | Me, Ve = Ie | qe, _e = ["x", "y"], je = ["clientX", "clientY"];
    C.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var Le = {mousedown: Ce, mousemove: $e, mouseup: Te}, ze = "mousedown", Fe = "mousemove mouseup";
    u(L, C, {
        handler: function (t) {
            var e = Le[t.type];
    ...
    var Qe = {pointerdown: Ce, pointermove: $e, pointerup: Te, pointercancel: Oe, pointerout: Oe}, We = {
        2: be,
        3: we,
        4: xe,
        5: ke
    }, Ne = "pointerdown", Re = "pointermove pointerup pointercancel";
    t.MSPointerEvent && (Ne = "MSPointerDown", Re = "MSPointerMove MSPointerUp MSPointerCancel"), u(z, C, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Qe[n], a = We[t.pointerType] || t.pointerType, r = a == be, s = m(e, t.pointerId, "pointerId");
            o & Ce && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : o & (Te | Oe) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, o, {
                pointers: e,
                changedPointers: [t],
                pointerType: a,
                srcEvent: t
    ...
    var He = {
        ...
        touchend: Te,
        touchcancel: Oe
    }, Ye = "touchstart", Xe = "touchstart touchmove touchend touchcancel";
    u(F, C, {
        handler: function (t) {
            var e = He[t.type];
            if (e === Ce && (this.started = !0), this.started) {
                var i = Q.call(this, t, e);
                e & (Te | Oe) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: be,
                    srcEvent: t
    ...
    u(W, C, {
        handler: function (t) {
            var e = Be[t.type], i = N.call(this, t, e);
            i && this.callback(this.manager, e, {pointers: i[0], changedPointers: i[1], pointerType: be, srcEvent: t})
        }
    }), u(R, C, {
        handler: function (t, e, i) {
            var n = i.pointerType == be, o = i.pointerType == xe;
            if (n)this.mouse.allow = !1; else if (o && !this.mouse.allow)return;
            e & (Te | Oe) && (this.mouse.allow = !0), this.callback(t, e, i)
        }, destroy: function () {
            this.touch.destroy(), this.mouse.destroy()
        }
    });
    var Ge = x(ue.style, "touchAction"), Ze = Ge !== n, Je = "compute", Ke = "auto", ti = "manipulation", ei = "none", ii = "pan-x", ni = "pan-y";
    H.prototype = {
        set: function (t) {
            ...
            if (!Ze) {
                ...
                var n = this.actions, o = g(n, ei), a = g(n, ni), r = g(n, ii);
                return o || a && i & Ie || r && i & qe ? this.preventSrc(e) : void 0
            }
        }, preventSrc: function (t) {
            this.manager.session.prevented = !0, t.preventDefault()
        }
    };
    var oi = 1, ai = 2, ri = 4, si = 8, li = si, ui = 16, ci = 32;
    X.prototype = {
        defaults: {}, set: function (t) {
            ...
            return t = G(t, this), -1 === m(e, t) && (e.push(t), t.requireFailure(this)), this
            ...
            var e = s({}, t);
            return d(this.options.enable, [this, e]) ? (this.state & (li | ui | ci) && (this.state = oi), this.state = this.process(e), void(this.state & (ai | ri | si | ui) && this.tryEmit(e))) : (this.reset(), void(this.state = ci))
        }, process: function () {
        ...
        defaults: {pointers: 1}, attrTest: function (t) {
            ...
            var e = this.state, i = t.eventType, n = e & (ai | ri), o = this.attrTest(t);
            return n && (i & Oe || !o) ? e | ui : n || o ? i & Te ? e | si : e & ai ? e | ri : ai : ci
        }
    }), u(J, Z, {
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: Ve}, getTouchAction: function () {
            var t = this.options.direction, e = [];
            return t & Ie && e.push(ni), t & qe && e.push(ii), e
        }, directionTest: function (t) {
            var e = this.options, i = !0, n = t.distance, o = t.direction, a = t.deltaX, r = t.deltaY;
            return o & e.direction || (e.direction & Ie ? (o = 0 === a ? Pe : 0 > a ? Ae : Ee, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? Pe : 0 > r ? De : Me, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
        }, attrTest: function (t) {
            return Z.prototype.attrTest.call(this, t) && (this.state & ai || !(this.state & ai) && this.directionTest(t))
        }, emit: function (t) {
        ...
        defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & (Te | Oe) && !a)this.reset(); else if (t.eventType & Ce)this.reset(), this._timer = o(function () {
                this.state = li, this.tryEmit()
            }, e.time, this); else if (t.eventType & Te)return li;
            return ci
        }, reset: function () {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .65, direction: Ie | qe, pointers: 1},
        getTouchAction: function () {
            return J.prototype.getTouchAction.call(this)
        },
        attrTest: function (t) {
            var e, i = this.options.direction;
            return i & (Ie | qe) ? e = t.velocity : i & Ie ? e = t.velocityX : i & qe && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pe(e) > this.options.velocity && t.eventType & Te
        },
        emit: function (t) {
            var e = U(t.direction);
        ...
        defaults: {
            ...
            if (n && a && i) {
                ...
                var r = this.pTime ? t.timeStamp - this.pTime < e.interval : !0, s = !this.pCenter || q(this.pCenter, t.center) < e.posThreshold;
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[ee, {enable: !1}], [K, {enable: !1}, ["rotate"]], [ie, {direction: Ie}], [J, {direction: Ie}, ["swipe"]], [ne], [ne, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [te]],
        cssProps: {
    ...
    ae.prototype = {
        set: function (t) {
            ...
            if (!e.stopped) {
                ...
                for (var a = 0; a < n.length;)i = n[a], e.stopped === pi || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (ai | ri | si) && (o = e.curRecognizer = i), a++
            }
        }, get: function (t) {
    ...
    def: "easeOutQuad", swing: function (t, e, i, n, o) {
        ...
        return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r)) + i
        ...
        return s * Math.pow(2, -10 * e) * Math.sin(2 * (e * o - a) * Math.PI / r) + n + i
    }, easeInOutElastic: function (t, e, i, n, o) {
        var a = 1.70158, r = 0, s = n;
        if (0 == e)return i;
        if (2 == (e /= o / 2))return i + n;
        if (r || (r = .3 * o * 1.5), s < Math.abs(n)) {
            s = n;
            var a = r / 4
        } else var a = r / (2 * Math.PI) * Math.asin(n / s);
        return 1 > e ? -.5 * s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r) + i : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r) * .5 + n + i
    ...
    t.fn.extend({
        openModal: function (e) {
            var i = this, n = t('<div id="lean-overlay"></div>');
            t("body").append(n);
            var o = {
                opacity: .5,
                in_duration: 350,
            ...
            e = t.extend(o, e), e.dismissible && (t("#lean-overlay").click(function () {
                ...
                t(i).closeModal(e)
            }), t("#lean-overlay").css({display: "block", opacity: 0}), t(i).css({
                display: "block",
                opacity: 0
                ...
                queue: !1,
                ease: "easeOutCubic"
            }), t(i).hasClass("bottom-sheet") ? t(i).velocity({bottom: "0", opacity: 1}, {
                duration: e.in_duration,
                queue: !1,
                ease: "easeOutCubic",
                complete: function () {
            ...
            }) : (t(i).css({top: "4%"}), t(i).velocity({top: "10%", opacity: 1}, {
                duration: e.in_duration,
                queue: !1,
                ease: "easeOutCubic",
                complete: function () {
        ...
        closeModal: function (e) {
            var i = {out_duration: 250, complete: void 0}, e = t.extend(i, e);
    ...
    t.fn.materialbox = function () {
        return this.each(function () {
            function e() {
                n = !1;
                var e = r.parent(".material-placeholder"), o = (window.innerWidth, window.innerHeight, r.data("width")), s = r.data("height");
                r.velocity("stop", !0), t("#materialbox-overlay").velocity("stop", !0), t(".materialbox-caption").velocity("stop", !0), t("#materialbox-overlay").velocity({opacity: 0}, {
                    duration: a,
                    queue: !1,
                    easing: "easeOutQuad",
                    complete: function () {
                ...
                }), r.velocity({width: o, height: s, left: 0, top: 0}, {
                    duration: a,
                    queue: !1,
                    easing: "easeOutQuad"
                    ...
                    easing: "easeOutQuad",
                    complete: function () {
                        e.css({height: "", width: "", position: "", top: "", left: ""}), r.css({
                            height: "",
                            top: "",
                            left: "",
                            width: "",
            ...
            if (!t(this).hasClass("intialized")) {
                ...
                var i = !1, n = !0, o = 275, a = 200, r = t(this), s = t("<div></div>").addClass("material-placeholder");
                r.wrap(s), r.on("click", function () {
                    var a = r.parent(".material-placeholder"), s = window.innerWidth, l = window.innerHeight, u = r.width(), c = r.height();
                    if (n === !1)return e(), !1;
                    if (i && n === !0)return e(), !1;
                    n = !1, r.addClass("active"), i = !0, a.css({
                        width: a[0].getBoundingClientRect().width,
                        height: a[0].getBoundingClientRect().height,
                        position: "relative",
                        top: 0,
                        left: 0
                    }), r.css({position: "absolute", "z-index": 1101}).data("width", u).data("height", c);
                    ...
                    if (t("body").append(d), d.velocity({opacity: 1}, {
                        ...
                        p.text(r.data("caption")), t("body").append(p), p.css({display: "inline"}), p.velocity({opacity: 1}, {
                            duration: o,
                            queue: !1,
                            easing: "easeOutQuad"
                        })
                    }
                    var h = 0, f = u / s, v = c / l, g = 0, y = 0;
                    f > v ? (h = c / u, g = .9 * s, y = .9 * s * h) : (h = u / c, g = .9 * l * h, y = .9 * l), r.hasClass("responsive-img") ? r.velocity({
                        "max-width": g,
                        width: u
                    }, {
                        duration: 0, queue: !1, complete: function () {
                            r.css({left: 0, top: 0}).velocity({
                                height: y,
                                width: g,
                                left: t(document).scrollLeft() + s / 2 - r.parent(".material-placeholder").offset().left - g / 2,
                                top: t(document).scrollTop() + l / 2 - r.parent(".material-placeholder").offset().top - y / 2
                            }, {
    ...
    t.fn.parallax = function () {
        ...
        return this.each(function () {
            function i(i) {
                var o;
                o = 601 > e ? n.height() > 0 ? n.height() : n.children("img").height() : n.height() > 0 ? n.height() : 500;
                var a = n.children("img").first(), r = a.height(), s = r - o, l = n.offset().top + o, u = n.offset().top, c = t(window).scrollTop(), d = window.innerHeight, p = c + d, h = (p - u) / (o + d), f = Math.round(s * h);
                i && a.css("display", "block"), l > c && c + d > u && a.css("transform", "translate3D(-50%," + f + "px, 0)")
            }
    ...
    t(document).ready(function () {
        t.fn.pushpin = function (e) {
            ...
            return e = t.extend(i, e), $index = 0, this.each(function () {
                ...
                n(a, t(window).scrollTop()), t(window).on("scroll." + o, function () {
        ...
        window.addEventListener("scroll", function () {
            ...
            if (e) {
                ...
                for (var i = window.pageYOffset + window.innerHeight, n = 0; n < t.length; n++) {
                    var o = t[n], a = o.selector, r = o.offset, s = o.callback, l = document.querySelector(a);
                    if (null !== l) {
    ...
    function e(e, i, n, o) {
        ...
        return t.each(r, function (t, r) {
            if (r.height() > 0) {
                var s = r.offset().top, l = r.offset().left, u = l + r.width(), c = s + r.height(), d = !(l > i || o > u || s > n || e > c);
                d && a.push(r)
            }
        }), a
    }
    ...
    function i() {
        ++u;
        var i = a.scrollTop(), n = a.scrollLeft(), o = n + a.width(), r = i + a.height(), l = e(i + c.top + 200, o + c.right, r + c.bottom, n + c.left);
    ...
    function o(t, e, i) {
        ...
        i || (i = {});
        var l = function () {
            s = i.leading === !1 ? 0 : d(), r = null, a = t.apply(n, o), n = o = null
        };
        return function () {
            var u = d();
            s || i.leading !== !1 || (s = u);
            var c = e - (u - s);
            return n = this, o = arguments, 0 >= c ? (clearTimeout(r), r = null, s = u, a = t.apply(n, o), n = o = null) : r || i.trailing === !1 || (r = setTimeout(l, c)), a
        }
    }

    var a = t(window), r = [], s = [], l = !1, u = 0, c = {
        top: 0,
        right: 0,
        bottom: 0,
        left: 0
    ...
    t.scrollSpy = function (e, n) {
        ...
        var u = o(i, n.throttle || 100), d = function () {
            t(document).ready(u)
        };
        return l || (a.on("scroll", d), a.on("resize", d), l = !0), setTimeout(d, 0), e.on("scrollSpy:enter", function () {
        ...
        return t.winSizeSpy = function () {
            return a
        }, e = e || {throttle: 100}, a.on("resize", o(n, e.throttle || 100))
    ...
    var e = {
        init: function (e) {
            ...
            e = t.extend(i, e), t(this).each(function () {
                function i(i) {
                    a = !1, r = !1, t("#sidenav-overlay").velocity({opacity: 0}, {
                        duration: 200,
                        queue: !1,
                        easing: "easeOutQuad",
                        complete: function () {
                        ...
                        easing: "easeOutCubic",
                        complete: function () {
                            1 == i && (o.removeAttr("style"), o.css("width", e.menuWidth))
                        }
                    })) : (t(".drag-target").css({
                        width: "",
                        right: "0",
                ...
                240 != e.menuWidth && o.css("width", e.menuWidth), t("body").append(t('<div class="drag-target"></div>')), "left" == e.edge ? (o.css("left", -1 * (e.menuWidth + 10)), t(".drag-target").css({left: 0})) : (o.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""), t(".drag-target").css({right: 0})), o.hasClass("fixed") && t(window).width() > 992 && o.css("left", 0), o.hasClass("fixed") && t(window).resize(function () {
                    window.innerWidth > 992 ? 0 != t("#sidenav-overlay").css("opacity") && r ? i(!0) : (o.removeAttr("style"), o.css("width", e.menuWidth)) : r === !1 && ("left" === e.edge ? o.css("left", -1 * (e.menuWidth + 10)) : o.css("right", -1 * (e.menuWidth + 10)))
                }), 1 == e.closeOnClick && o.on("click.itemclick", "a:not(.collapsible-header)", function () {
                    i()
                });
                var a = !1, r = !1;
                t(".drag-target").on("click", function () {
                    ...
                    if ("touch" == n.gesture.pointerType) {
                        ...
                        if ("left" === e.edge && (a > e.menuWidth ? a = e.menuWidth : 0 > a && (a = 0)), "left" === e.edge)a < e.menuWidth / 2 ? r = !1 : a >= e.menuWidth / 2 && (r = !0), o.css("left", a - e.menuWidth); else {
                            a < t(window).width() - e.menuWidth / 2 ? r = !0 : a >= t(window).width() - e.menuWidth / 2 && (r = !1);
                            var l = -1 * (a - e.menuWidth / 2);
                            l > 0 && (l = 0), o.css("right", l)
                        }
                        if ("left" === e.edge) {
                            var u = a / e.menuWidth;
                            t("#sidenav-overlay").velocity({opacity: u}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })
                        } else {
                            var u = Math.abs((a - t(window).width()) / e.menuWidth);
                            t("#sidenav-overlay").velocity({opacity: u}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                    ...
                    if ("touch" == i.gesture.pointerType) {
                        ...
                        a = !1, "left" === e.edge ? r && .3 >= n || -.5 > n ? (o.velocity({left: 0}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
                            ...
                            right: 0,
                            left: ""
                        })) : (!r || n > .3) && (o.velocity({left: -1 * (e.menuWidth + 10)}, {
                            duration: 200,
                            queue: !1,
                            easing: "easeOutQuad"
                            ...
                            right: "",
                            left: 0
                        })) : (!r || -.3 > n) && (o.velocity({right: -1 * (e.menuWidth + 10)}, {
                            duration: 200,
                            queue: !1,
                            easing: "easeOutQuad"
                        }), t("#sidenav-overlay").velocity({opacity: 0}, {
                    ...
                    if (1 == r)r = !1, a = !1, i(); else {
                        ...
                        n.css("opacity", 0).click(function () {
                            r = !1, a = !1, i(), n.velocity({opacity: 0}, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad",
                                complete: function () {
    ...
    t.fn.slider = function (e) {
        ...
        return e = t.extend(i, e), this.each(function () {
            ...
            function n(t) {
                t >= s.length ? t = 0 : 0 > t && (t = s.length - 1), l = r.find(".active").index(), l != t && (o = s.eq(l), $caption = o.find(".caption"), o.removeClass("active"), o.velocity({opacity: 0}, {
            ...
            var o, a = t(this), r = a.find("ul.slides").first(), s = r.find("li"), l = r.find(".active").index();
            if (-1 != l && (o = s.eq(l)), 400 != e.height && (a.height(e.height + 40), r.height(e.height)), s.find(".caption").each(function () {
                    i(t(this), 0)
                ...
                s.each(function () {
                    ...
                    i.click(function () {
                        var i = r.parent(), o = i.find(t(this)).index();
                ...
                }), a.append(u), u = a.find("ul.indicators").find("li.indicator-item")
            }
            o ? o.show() : (s.first().addClass("active").velocity({opacity: 1}, {
                duration: e.transition,
                queue: !1,
                easing: "easeOutQuad"
            }), l = 0, o = s.eq(l), e.indicators && u.eq(l).addClass("active")), o.find("img").each(function () {
            ...
            a.hammer({prevent_default: !1}).bind("pan", function (t) {
                if ("touch" === t.gesture.pointerType) {
                    ...
                    $curr_slide = r.find(".active"), $curr_slide.velocity({translateX: i}, {
                        duration: 50,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), 4 === e && (i > a.innerWidth() / 2 || -.65 > n) ? p = !0 : 2 === e && (i < -1 * a.innerWidth() / 2 || n > .65) && (d = !0);
                    var o;
                    d && (o = $curr_slide.next(), 0 === o.length && (o = s.first()), o.velocity({opacity: 1}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    })), p && (o = $curr_slide.prev(), 0 === o.length && (o = s.last()), o.velocity({opacity: 1}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }))
                ...
                "touch" === t.gesture.pointerType && ($curr_slide = r.find(".active"), c = !1, curr_index = r.find(".active").index(), p || d ? d ? (n(curr_index + 1), $curr_slide.velocity({translateX: -1 * a.innerWidth()}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad",
                    complete: function () {
    ...
    var e = {
        init: function () {
            return this.each(function () {
                function e() {
                    return c = p.hasClass("rtl"), c ? {right: u * l, left: s - (u + 1) * l} : {
                        right: s - (u + 1) * l,
                        left: u * l
                    }
                }
                ...
                var o, a, r = i.find("li.tab a"), s = i.width(), l = i.find("li").first().outerWidth(), u = 0, c = !1;
                o = t(r.filter('[href="' + location.hash + '"]')), 0 === o.length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), u = r.index(o), 0 > u && (u = 0), a = t(o[0].hash), i.append('<div class="indicator"></div>');
                var d = i.find(".indicator"), p = t("html");
                i.is(":visible") && (d.css({left: s - (u + 1) * l}), d.css({right: u * l})), t(window).resize(function () {
                    s = i.width(), l = i.find("li").first().outerWidth(), 0 > u && (u = 0), 0 !== l && 0 !== s && (d.css({right: s - (u + 1) * l}), d.css({left: u * l}))
                }), r.not(o).each(function () {
                    t(this.hash).hide()
                }), i.on("click", "a", function (n) {
                    s = i.width(), l = i.find("li").first().outerWidth(), o.removeClass("active"), a.hide(), o = t(this), a = t(this.hash), r = i.find("li.tab a"), o.addClass("active");
                    var p = u;
                    u = r.index(t(this)), 0 > u && (u = 0), a.show();
                    var h = e();
                    !c && u - p >= 0 || c && 0 > u - p ? (d.velocity({right: h.right}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), d.velocity({left: h.left}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad",
                        delay: 90
    ...
    function o(t) {
        ...
        if (e.classList.add("toast"), i)for (var o = i.split(" "), a = 0, r = o.length; r > a; a++)e.classList.add(o[a]);
        e.innerHTML = t;
        ...
        return s.on("pan", function (t) {
            ...
            0 > o && (o = 0), $.Velocity(e, {left: i, opacity: o}, {duration: 50, queue: !1, easing: "easeOutQuad"})
        }), s.on("panend", function (t) {
            var i = t.deltaX, o = 80;
            Math.abs(i) > o ? $.Velocity(e, {marginTop: "-40px"}, {
                duration: 375,
                easing: "easeOutExpo",
                queue: !1,
                complete: function () {
            ...
            }) : (e.classList.remove("panning"), $.Velocity(e, {left: 0, opacity: 1}, {
                duration: 300,
                easing: "easeOutExpo",
                queue: !1
            }))
    ...
    if (null === a) {
        ...
        a.id = "toast-container", document.body.appendChild(a)
    }
    var r = o(t);
    a.appendChild(r), r.style.top = "35px", r.style.opacity = 0, $.Velocity(r, {top: "0px", opacity: 1}, {
        duration: 300,
        easing: "easeOutCubic",
        queue: !1
    });
    var s = e, l = setInterval(function () {
        null === r.parentNode && window.clearInterval(l), r.classList.contains("panning") || (s -= 20), 0 >= s && ($.Velocity(r, {
            opacity: 0,
            marginTop: "-40px"
        }, {
    ...
    t.fn.tooltip = function (e) {
        var i = null, n = !1, o = null, a = 5, r = {delay: 350};
        return e = t.extend(r, e), t(".material-tooltip").remove(), this.each(function () {
            var r = t(this), s = t("<span></span>").text(r.attr("data-tooltip")), l = t("<div></div>");
            ...
            u.appendTo(l), u.css({
                ...
                mouseenter: function (t) {
                    t.stopPropagation();
                    var s = r.data("delay");
                    s = void 0 == s || "" == s ? e.delay : s, i = 0, o = setInterval(function () {
                        if (i += 10, i >= s && 0 == n) {
                            n = !0, l.css({
                                display: "block",
                                left: "0px",
                                top: "0px"
                            }), l.children("span").text(r.attr("data-tooltip"));
                            var t = r.outerWidth(), e = r.outerHeight(), o = r.attr("data-position"), c = l.outerHeight(), d = l.outerWidth(), p = "0px", h = "0px", f = 8;
                            "top" === o ? (l.css({
                                ...
                                left: r.offset().left + t / 2 - d / 2
                            }), p = "+10px", u.css({marginLeft: d / 2 - u.width() / 2})), f = d / 8, 8 > f && (f = 8), ("right" === o || "left" === o) && (f = d / 10, 6 > f && (f = 6)), l.velocity({
                                opacity: 1,
                                marginTop: p,
                                marginLeft: h
            ...
            t(this).hammer({prevent_default: !1}).bind("pan", function (n) {
                if ("touch" === n.gesture.pointerType) {
                    ...
                    o.velocity({translateX: r}, {
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), 4 === a && (r > o.innerWidth() / 2 || -.75 > s) ? e = !0 : 2 === a && (r < -1 * o.innerWidth() / 2 || s > .75) && (i = !0)
                }
    ...
    if (!t.jQuery) {
        ...
        i.isWindow = function (t) {
            ...
            var t, e, n, o, a, r, s = arguments[0] || {}, l = 1, u = arguments.length, c = !1;
            for ("boolean" == typeof s && (c = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++)if (null != (a = arguments[l]))for (o in a)t = s[o], n = a[o], s !== n && (c && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, r = t && i.isArray(t) ? t : []) : r = t && i.isPlainObject(t) ? t : {}, s[o] = i.extend(c, r, n)) : void 0 !== n && (s[o] = n));
            return s
    ...
    return function (t, e, i, n) {
        ...
        function l(t, i, n, o) {
            ...
            function p(e, i, o) {
                var a, r, s = 0;
                do r = i + (o - i) / 2, a = l(r, t, n) - e, a > 0 ? o = r : i = r; while (Math.abs(a) > y && ++s < m);
                return r
            }
            ...
            function h(e) {
                ...
                --o;
                var r = (e - S[o]) / (S[o + 1] - S[o]), s = i + r * w, l = u(s, t, n);
            ...
            var v = 4, g = .001, y = 1e-7, m = 10, b = 11, w = 1 / (b - 1), x = "Float32Array"in e;
            if (4 !== arguments.length)return !1;
            for (var k = 0; 4 > k; ++k)if ("number" != typeof arguments[k] || isNaN(arguments[k]) || !isFinite(arguments[k]))return !1;
            t = Math.min(t, 1), n = Math.min(n, 1), t = Math.max(t, 0), n = Math.max(n, 0);
            var S = x ? new Float32Array(b) : new Array(b), C = !1, $ = function (e) {
                return C || f(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(h(e), i, o)
            };
        ...
        function u(t, e) {
            var i = t;
            return v.isString(t) ? b.Easings[t] || (i = !1) : i = v.isArray(t) && 1 === t.length ? s.apply(null, t) : v.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : v.isArray(t) && 4 === t.length ? l.apply(null, t) : !1, i === !1 && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : m), i
        }
        ...
        function c(t) {
            if (t) {
                ...
                for (var a = 0; i > a; a++)if (b.State.calls[a]) {
                    var s = b.State.calls[a], l = s[0], u = s[2], h = s[3], f = !!h, g = null;
                    h || (h = b.State.calls[a][3] = e - 16);
                    for (var y = Math.min((e - h) / u.duration, 1), m = 0, w = l.length; w > m; m++) {
                        var k = l[m], C = k.element;
                        if (r(C)) {
                            var $ = !1;
                            ...
                            for (var O in k)if ("element" !== O) {
                                var P, A = k[O], E = v.isString(A.easing) ? b.Easings[A.easing] : A.easing;
                                if (1 === y)P = A.endValue; else {
                                    var D = A.endValue - A.startValue;
                                    if (P = A.startValue + D * E(y, u, D), !f && P === A.currentValue)continue
                                }
                                if (A.currentValue = P, "tween" === O)g = P; else {
                                    if (x.Hooks.registered[O]) {
                                        var M = x.Hooks.getRoot(O), I = r(C).rootPropertyValueCache[M];
                                        I && (A.rootPropertyValue = I)
                                    }
                                    var q = x.setPropertyValue(C, O, A.currentValue + (0 === parseFloat(P) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
                                    x.Hooks.registered[O] && (r(C).rootPropertyValueCache[M] = x.Normalizations.registered[M] ? x.Normalizations.registered[M]("extract", null, q[1]) : q[1]), "transform" === q[0] && ($ = !0)
                                }
                            }
                            u.mobileHA && r(C).transformCache.translate3d === n && (r(C).transformCache.translate3d = "(0px, 0px, 0px)", $ = !0), $ && x.flushTransformCache(C)
                        }
                    }
                    u.display !== n && "none" !== u.display && (b.State.calls[a][2].display = !1), u.visibility !== n && "hidden" !== u.visibility && (b.State.calls[a][2].visibility = !1), u.progress && u.progress.call(s[1], s[1], y, Math.max(0, h + u.duration - e), h, g), 1 === y && d(a)
                }
            }
        ...
        function d(t, e) {
            ...
            for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                var d = i[u].element;
                if (e || a.loop || ("none" === a.display && x.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(d, "visibility", a.visibility)), a.loop !== !0 && (p.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && r(d)) {
                ...
                s && a.loop !== !0 && s(o), r(d) && a.loop === !0 && !e && (p.each(r(d).tweensContainer, function (t, e) {
                    /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100)
                }), b(d, "reverse", {loop: !0, delay: a.delay})), a.queue !== !1 && p.dequeue(d, a.queue)
            }
            b.State.calls[t] = !1;
        ...
        var w = function () {
            ...
            function i(i, n) {
                var o = {
                    dx: i.v,
                    dv: t(i)
                }, a = e(i, .5 * n, o), r = e(i, .5 * n, a), s = e(i, n, r), l = 1 / 6 * (o.dx + 2 * (a.dx + r.dx) + s.dx), u = 1 / 6 * (o.dv + 2 * (a.dv + r.dv) + s.dv);
                return i.x = i.x + l * n, i.v = i.v + u * n, i
            }

            return function n(t, e, o) {
                var a, r, s, l = {x: -1, v: 0, tension: null, friction: null}, u = [0], c = 0, d = 1e-4, p = .016;
                for (t = parseFloat(t) || 500, e = parseFloat(e) || 20, o = o || null, l.tension = t, l.friction = e, a = null !== o, a ? (c = n(t, e), r = c / o * p) : r = p; s = i(s || l, r), u.push(1 + s.x), c += 16, Math.abs(s.x) > d && Math.abs(s.v) > d;);
                return a ? function (t) {
        ...
        var x = b.CSS = {
            ...
            Hooks: {
                templates: {
                    ...
                    var i, n, o;
                    if (h)for (i in x.Hooks.templates) {
            ...
            getPropertyValue: function (t, i, o, a) {
                function s(t, i) {
                    ...
                    if (8 >= h)l = p.css(t, i); else {
                        var u = !1;
                        if (/^(width|height)$/.test(i) && 0 === x.getPropertyValue(t, "display") && (u = !0, x.setPropertyValue(t, "display", x.Values.getDisplayType(t))), !a) {
                        ...
                        var f;
                        f = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), l = 9 === h && "filter" === i ? f.getPropertyValue(i) : f[i], ("" === l || null === l) && (l = t.style[i]), o()
                    }
        ...
        var k = function () {
            ...
            function o() {
                function t() {
                    function t(t, e) {
                        var i = n, o = n, r = n;
                        return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (v.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (o = e ? t[1] : u(t[1], s.duration), t[2] !== n && (r = t[2]))) : i = t, e || (o = o || s.easing), v.isFunction(i) && (i = i.call(a, C, S)), v.isFunction(r) && (r = r.call(a, C, S)), [i || 0, o, r]
                    }
                    ...
                    function h() {
                        ...
                        }, n = t.position === q.lastPosition && t.myParent === q.lastParent, o = t.fontSize === q.lastFontSize;
                        q.lastParent = t.myParent, q.lastPosition = t.position, q.lastFontSize = t.fontSize;
                        var s = 100, l = {};
                        if (o && n)l.emToPx = q.lastEmToPx, l.percentToPxWidth = q.lastPercentToPxWidth, l.percentToPxHeight = q.lastPercentToPxHeight; else {
                            var u = r(a).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                            ...
                            }), b.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = q.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = q.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = q.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / s, t.myParent.removeChild(u)
                        }
                    ...
                    if ("scroll" === P) {
                        var w, k, $, T = /^x$/i.test(s.axis) ? "Left" : "Top", A = parseFloat(s.offset) || 0;
                        s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, w = s.container["scroll" + T], $ = w + p(a).position()[T.toLowerCase()] + A) : s.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + T]], k = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], $ = p(a).offset()[T.toLowerCase()] + A), l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: w,
                                currentValue: w,
                                ...
                                unitType: "",
                                easing: s.easing,
                                scrollData: {container: s.container, direction: T, alternateValue: k}
                            }, element: a
                        }, b.debug && console.log("tweensContainer (scroll): ", l.scroll, a)
                    } else if ("reverse" === P) {
                        if (!r(a).tweensContainer)return void p.dequeue(a, s.queue);
                        "none" === r(a).opts.display && (r(a).opts.display = "auto"), "hidden" === r(a).opts.visibility && (r(a).opts.visibility = "visible"), r(a).opts.loop = !1, r(a).opts.begin = null, r(a).opts.complete = null, m.easing || delete s.easing, m.duration || delete s.duration, s = p.extend({}, r(a).opts, s);
                        var E = p.extend(!0, {}, r(a).tweensContainer);
                        for (var D in E)if ("element" !== D) {
                            var M = E[D].startValue;
                            E[D].startValue = E[D].currentValue = E[D].endValue, E[D].endValue = M, v.isEmptyObject(m) || (E[D].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(E[D]), a)
                        }
                        l = E
                    } else if ("start" === P) {
                        var E;
                        r(a).tweensContainer && r(a).isAnimating === !0 && (E = r(a).tweensContainer), p.each(g, function (e, i) {
                            if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                var o = t(i, !0), a = o[0], r = o[1], s = o[2];
                                if (x.RegEx.isHex.test(a)) {
                                    for (var l = ["Red", "Green", "Blue"], u = x.Values.hexToRgb(a), c = s ? x.Values.hexToRgb(s) : n, d = 0; d < l.length; d++) {
                                        var p = [u[d]];
                                        r && p.push(r), c !== n && p.push(c[d]), g[e + l[d]] = p
                                    }
                                    delete g[e]
                                }
                            }
                        ...
                        for (var I in g) {
                            var _ = t(g[I]), j = _[0], L = _[1], z = _[2];
                            I = x.Names.camelCase(I);
                            var F = x.Hooks.getRoot(I), Q = !1;
                            if (r(a).isSVG || "tween" === F || x.Names.prefixCheck(F)[1] !== !1 || x.Normalizations.registered[F] !== n) {
                                (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(I) && !z && 0 !== j && (z = 0), s._cacheValues && E && E[I] ? (z === n && (z = E[I].endValue + E[I].unitType), Q = r(a).rootPropertyValueCache[F]) : x.Hooks.registered[I] ? z === n ? (Q = x.getPropertyValue(a, F), z = x.getPropertyValue(a, I, Q)) : Q = x.Hooks.templates[F][1] : z === n && (z = x.getPropertyValue(a, I));
                                var W, N, R, H = !1;
                                if (W = d(I, z), z = W[0], R = W[1], W = d(I, j), j = W[0].replace(/^([+-\/*])=/, function (t, e) {
                                        return H = e, ""
                                    }), N = W[1], z = parseFloat(z) || 0, j = parseFloat(j) || 0, "%" === N && (/^(fontSize|lineHeight)$/.test(I) ? (j /= 100, N = "em") : /^scale/.test(I) ? (j /= 100, N = "") : /(Red|Green|Blue)$/i.test(I) && (j = j / 100 * 255, N = "")), /[\/*]/.test(H))N = R; else if (R !== N && 0 !== z)if (0 === j)N = R; else {
                                    o = o || h();
                                    var Y = /margin|padding|left|right|width|text|word|letter/i.test(I) || /X$/.test(I) || "x" === I ? "x" : "y";
                                    switch (R) {
                                        case"%":
                                            z *= "x" === Y ? o.percentToPxWidth : o.percentToPxHeight;
                                            break;
                                        case"px":
                                            break;
                                        default:
                                    ...
                                    switch (N) {
                                        case"%":
                                            z *= 1 / ("x" === Y ? o.percentToPxWidth : o.percentToPxHeight);
                                            break;
                                        case"px":
                                            break;
                                        default:
                    ...
                    l.element && (x.Values.addClass(a, "velocity-animating"), V.push(l), "" === s.queue && (r(a).tweensContainer = l, r(a).opts = s), r(a).isAnimating = !0, C === S - 1 ? (b.State.calls.push([V, f, s, null, O.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : C++)
                }

                var o, a = this, s = p.extend({}, b.defaults, m), l = {};
                switch (r(a) === n && b.init(a), parseFloat(s.delay) && s.queue !== !1 && p.queue(a, s.queue, function (t) {
                ...
                b.mock !== !1 && (b.mock === !0 ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = u(s.easing, s.duration), s.begin && !v.isFunction(s.begin) && (s.begin = null), s.progress && !v.isFunction(s.progress) && (s.progress = null), s.complete && !v.isFunction(s.complete) && (s.complete = null), s.display !== n && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(a))), s.visibility !== n && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, s.queue === !1 ? s.delay ? setTimeout(t, s.delay) : t() : p.queue(a, s.queue, function (e, i) {
                    return i === !0 ? (O.promise && O.resolver(f), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                }), "" !== s.queue && "fx" !== s.queue || "inprogress" === p.queue(a)[0] || p.dequeue(a)
            }

            var s, l, h, f, g, m, w = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || v.isString(arguments[0].properties));
            if (v.isWrapped(this) ? (s = !1, h = 0, f = this, l = this) : (s = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                w ? (g = arguments[0].properties || arguments[0].p, m = arguments[0].options || arguments[0].o) : (g = arguments[h], m = arguments[h + 1]);
                var S = f.length, C = 0;
                if (!/^(stop|finish)$/i.test(g) && !p.isPlainObject(m)) {
                    var $ = h + 1;
                    m = {};
                    for (var T = $; T < arguments.length; T++)v.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? v.isString(arguments[T]) || v.isArray(arguments[T]) ? m.easing = arguments[T] : v.isFunction(arguments[T]) && (m.complete = arguments[T]) : m.duration = arguments[T]
                }
                    ...
                    case"stop":
                        ...
                        return p.each(b.State.calls, function (t, e) {
                            e && p.each(e[1], function (i, o) {
                                var a = m === n ? "" : m;
                                return a === !0 || e[2].queue === a || m === n && e[2].queue === !1 ? void p.each(f, function (i, n) {
                                    n === o && ((m === !0 || v.isString(m)) && (p.each(p.queue(n, v.isString(m) ? m : ""), function (t, e) {
                                        v.isFunction(e) && e(null, !0)
                                    }), p.queue(n, v.isString(m) ? m : "", [])), "stop" === g ? (r(n) && r(n).tweensContainer && a !== !1 && p.each(r(n).tweensContainer, function (t, e) {
                            ...
                            d(e, !0)
                        }), O.promise && O.resolver(f)), t();
                    default:
                        if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                            if (v.isString(g) && b.Redirects[g]) {
                                var E = p.extend({}, m), D = E.duration, M = E.delay || 0;
                                return E.backwards === !0 && (f = p.extend(!0, [], f).reverse()), p.each(f, function (t, e) {
                                    parseFloat(E.stagger) ? E.delay = M + parseFloat(E.stagger) * t : v.isFunction(E.stagger) && (E.delay = M + E.stagger.call(e, t, S)), E.drag && (E.duration = parseFloat(D) || (/^(callout|transition)/.test(g) ? 1e3 : y), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / S : (t + 1) / S), .75 * E.duration, 200)), b.Redirects[g].call(e, e, E || {}, t, S, f, O.promise ? O : n)
                                }), t()
                            }
                ...
                var _, E = p.extend({}, b.defaults, m);
                if (E.loop = parseInt(E.loop), _ = 2 * E.loop - 1, E.loop)for (var j = 0; _ > j; j++) {
                    var L = {delay: E.delay, progress: E.progress};
                    j === _ - 1 && (L.display = E.display, L.visibility = E.visibility, L.complete = E.complete), k(f, "reverse", L)
                }
                return t()
            }
        };
    ...
    var s = s || {}, l = document.querySelectorAll.bind(document), u = {
        duration: 750, show: function (t, e) {
            ...
            var r = n(i), s = t.pageY - r.top, l = t.pageX - r.left, c = "scale(" + i.clientWidth / 100 * 10 + ")";
            "touches"in t && (s = t.touches[0].pageY - r.top, l = t.touches[0].pageX - r.left), a.setAttribute("data-hold", Date.now()), a.setAttribute("data-scale", c), a.setAttribute("data-x", l), a.setAttribute("data-y", s);
    ...
    function e(a, r, l, d) {
        ...
        function h() {
            k.data(r, C).addClass(x.input).attr("tabindex", -1).val(k.data("value") ? C.get("select", w.format) : a.value), w.editable || k.on("focus." + b.id + " click." + b.id, function (t) {
                t.preventDefault(), C.$root[0].focus()
            }).on("keydown." + b.id, g), o(a, {haspopup: !0, expanded: !1, readonly: !1, owns: a.id + "_root"})
        }
        ...
        function f() {
            C.$root.on({
                ...
                var e = t(this), i = e.data(), n = e.hasClass(x.navDisabled) || e.hasClass(x.disabled), o = s();
        ...
        function v() {
            var e;
            w.hiddenName === !0 ? (e = a.name, a.name = "") : (e = ["string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "", "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit"], e = e[0] + a.name + e[1]), C._hidden = t('<input type=hidden name="' + e + '"' + (k.data("value") || a.value ? ' value="' + C.get("select", w.formatSubmit) + '"' : "") + ">")[0], k.on("change." + b.id, function () {
                C._hidden.value = a.value ? C.get("select", w.formatSubmit) : ""
        ...
        if (!a)return e;
        var m = !1, b = {id: a.id || "P" + Math.abs(~~(Math.random() * new Date))}, w = l ? t.extend(!0, {}, l.defaults, d) : d || {}, x = t.extend({}, e.klasses(), w.klass), k = t(a), S = function () {
            return this.start()
        }, C = S.prototype = {
            constructor: S, $node: k, start: function () {
                return b && b.start ? C : (b.methods = {}, b.start = !0, b.open = !1, b.type = a.type, a.autofocus = a == s(), a.readOnly = !w.editable, a.id = a.id || b.id, "text" != a.type && (a.type = "text"), C.component = new l(C, w), C.$root = t(e._.node("div", p(), x.picker, 'id="' + a.id + '_root" tabindex="0"')), f(), w.formatSubmit && v(), h(), w.container ? t(w.container).append(C.$root) : k.after(C.$root), C.on({
                    ...
                    close: w.onClose,
                    set: w.onSet
                }), m = i(C.$root.children()[0]), a.autofocus && C.open(), C.trigger("start").trigger("render"))
            }, render: function (t) {
                ...
                return b.start ? (C.close(), C._hidden && C._hidden.parentNode.removeChild(C._hidden), C.$root.remove(), k.removeClass(x.input).removeData(r), setTimeout(function () {
                    k.off("." + b.id)
                }, 0), a.type = b.type, a.readOnly = !1, C.trigger("stop"), b.methods = {}, b.start = !1, C) : C
            }, open: function (i) {
                return b.open ? C : (k.addClass(x.active), o(a, "expanded", !0), setTimeout(function () {
                    C.$root.addClass(x.opened), o(C.$root[0], "hidden", !1)
                }, 0), i !== !1 && (b.open = !0, m && c.css("overflow", "hidden").css("padding-right", "+=" + n()), C.$root[0].focus(), u.on("click." + b.id + " focusin." + b.id, function (t) {
                    var e = t.target;
                    e != a && e != document && 3 != t.which && C.close(e === C.$root.children()[0])
                }).on("keydown." + b.id, function (i) {
                    var n = i.keyCode, o = C.component.key[n], a = i.target;
                    27 == n ? C.close(!0) : a != C.$root[0] || !o && 13 != n ? t.contains(C.$root[0], a) && 13 == n && (i.preventDefault(), a.click()) : (i.preventDefault(), o ? e._.trigger(C.component.key.go, C, [e._.trigger(o)]) : C.$root.find("." + x.highlighted).hasClass(x.disabled) || C.set("select", C.component.item.highlight).close())
                })), C.trigger("open"))
            }, close: function (t) {
                return t && (C.$root.off("focus.toOpen")[0].focus(), setTimeout(function () {
                    C.$root.on("focus.toOpen", y)
                }, 0)), k.removeClass(x.active), o(a, "expanded", !1), setTimeout(function () {
                    C.$root.removeClass(x.opened + " " + x.focused), o(C.$root[0], "hidden", !0)
                }, 0), b.open ? (b.open = !1, m && c.css("overflow", "").css("padding-right", "-=" + n()), u.off("." + b.id), C.trigger("close")) : C
            }, clear: function (t) {
                ...
                if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
                    r || (s[e] = i);
                    for (o in s)a = s[o], o in C.component.item && (void 0 === a && (a = null), C.component.set(o, a, n)), ("select" == o || "clear" == o) && k.val("clear" == o ? "" : C.get(o, w.format)).trigger("change");
                    C.render()
                }
    ...
    i.prototype.set = function (t, e, i) {
        ...
        var o, r = this;
        return i = void 0 === i ? t : i, i == -1 / 0 || 1 / 0 == i ? o = i : e.isPlainObject(i) && a.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = a.isDate(i) ? i : r.create().obj) : i = a.isInteger(i) || a.isDate(i) ? r.normalize(new Date(i), n) : r.now(t, i, n), {
        ...
        var o, a, r, s, l = e.isArray(i), u = e.isPlainObject(i), c = this.item.view;
        if (l || u) {
            for (u ? (a = i.year, r = i.month, s = i.date) : (a = +i[0], r = +i[1], s = +i[2]), n && n.nav && c && c.month !== r && (a = c.year, r = c.month), o = new Date(a, r + (n && n.nav ? n.nav : 0), 1), a = o.getFullYear(), r = o.getMonth(); new Date(a, r, s).getMonth() !== r;)s -= 1;
            i = [a, r, s]
        }
        return i
        ...
        var i = this;
        return e ? "string" == typeof e ? e = i.parse(t, e) : a.isInteger(e) && (e = i.now(t, e, {rel: e})) : e = "min" == t ? -1 / 0 : 1 / 0, e
    }, i.prototype.viewset = function (t, e) {
        return this.create([e.year, e.month, 1])
    }, i.prototype.validate = function (t, i, n) {
        var o, r, s, l, u = this, c = i, d = n && n.interval ? n.interval : 1, p = -1 === u.item.enable, h = u.item.min, f = u.item.max, v = p && u.item.disable.filter(function (t) {
                if (e.isArray(t)) {
        ...
        return e && "string" == typeof e ? (i && i.format || (i = i || {}, i.format = n.settings.format), n.formats.toArray(i.format).map(function (t) {
            var i = n.formats[t], r = i ? a.trigger(i, n, [e, o]) : t.replace(/^!/, "").length;
        ...
        return "flip" == i ? n.flipEnable() : i === !1 ? (n.flipEnable(1), o = []) : i === !0 ? (n.flipEnable(-1), o = []) : i.map(function (t) {
            for (var i, r = 0; r < o.length; r += 1)if (n.isDateExact(t, o[r])) {
                i = !0;
                break
            }
        ...
        return "flip" == i ? n.flipEnable() : i === !0 ? (n.flipEnable(1), o = []) : i === !1 ? (n.flipEnable(-1), o = []) : i.map(function (t) {
            ...
            if (i)for (l = 0; r > l; l += 1)if (n.isDateExact(o[l], t)) {
                o[l] = null;
                break
            }
            if (u)for (l = 0; r > l; l += 1)if (n.isDateOverlap(o[l], t)) {
                o[l] = null;
                break
            }
            i && o.push(i)
        ...
        var e = this, i = e.settings, r = e.item, s = r.now, l = r.select, u = r.highlight, c = r.view, d = r.disable, p = r.min, h = r.max, f = function (t, e) {
            ...
            return a.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && c.year >= h.year && c.month >= h.month || !t && c.year <= p.year && c.month <= p.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + a.ariaAttr({
                role: "button",
                controls: e.$node[0].id + "_table"
            }) + ' title="' + (t ? i.labelMonthNext : i.labelMonthPrev) + '"')
        }, g = function (n) {
            var o = i.showMonthsShort ? i.monthsShort : i.monthsFull;
            return "short_months" == n && (o = i.monthsShort), i.selectMonths && void 0 == n ? a.node("select", a.group({
                min: 0,
                max: 11,
                i: 1,
                node: "option",
                item: function (t) {
                    return [o[t], 0, "value=" + t + (c.month == t ? " selected" : "") + (c.year == p.year && t < p.month || c.year == h.year && t > h.month ? " disabled" : "")]
                }
            }), i.klass.selectMonth + " browser-default", (t ? "" : "disabled") + " " + a.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + i.labelMonthSelect + '"') : "short_months" == n ? null != l ? a.node("div", o[l.month]) : a.node("div", o[c.month]) : a.node("div", o[c.month], i.klass.month)
        }, y = function (n) {
            var o = c.year, r = i.selectYears === !0 ? 5 : ~~(i.selectYears / 2);
            if (r) {
                var s = p.year, l = h.year, u = o - r, d = o + r;
                ...
                }), i.klass.selectYear + " browser-default", (t ? "" : "disabled") + " " + a.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + i.labelYearSelect + '"')
            }
            return "raw" == n ? a.node("div", o) : a.node("div", o, i.klass.year)
        };
        return createDayLabel = function () {
            ...
            return e
        }, a.node("div", a.node("div", createWeekdayLabel(), "picker__weekday-display") + a.node("div", g("short_months"), i.klass.month_display) + a.node("div", createDayLabel(), i.klass.day_display) + a.node("div", y("raw"), i.klass.year_display), i.klass.date_display) + a.node("div", a.node("div", (i.selectYears ? g() + y() : g() + y()) + v() + v(1), i.klass.header) + a.node("table", f + a.node("tbody", a.group({
            min: 0,
            max: o - 1,
            i: 1,
            node: "tr",
            item: function (t) {
                ...
                return [a.group({
                    min: n * t - c.day + o + 1, max: function () {
                        return this.min + n - 1
                    }, i: 1, node: "td", item: function (t) {
                        t = e.create([c.year, c.month, t + (i.firstDay ? 1 : 0)]);
                        var n = l && l.pick == t.pick, o = u && u.pick == t.pick, r = d && e.disabled(t) || t.pick < p.pick || t.pick > h.pick, f = a.trigger(e.formats.toString, e, [i.format, t]);
                        return [a.node("div", t.date, function (e) {
                            return e.push(c.month == t.month ? i.klass.infocus : i.klass.outfocus), s.pick == t.pick && e.push(i.klass.now), n && e.push(i.klass.selected), o && e.push(i.klass.highlighted), r && e.push(i.klass.disabled), e.join(" ")
